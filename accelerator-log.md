...
{
  "gitBranch" : "tap-1.0",
  "gitUrl" : "https://github.com/dbuchko/spring-sensors-rabbit.git",
  "projectName" : "spring-sensors-rabbit",
  "publisherRepository" : "tapdlb.azurecr.io/tap/supply-chain/spring-sensors-publisher",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/tanzu-end-to-end/spring-sensors.git->https://github.com/d...(truncated), main->tap-1.0]
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->tapdlb.azurecr.io/ta...(truncated)]
